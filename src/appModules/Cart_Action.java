...
public class Cart_Action {
	...
	public static void Verify_CartPage_Default_Content() throws Exception{
...
public static void CheckMiniCartShippingCostFinal(int iTestCaseRow) throws Exception {
	...
	public static void Verify_Private_Cart_Page_RemoveProduct(int iTestCaseRow) throws Exception {
		...
		try {
			...
			try {
				...
				if (!(Cart_Page.CartPageAlert().getText().trim().equals("Product has been removed from your cart."))) {
	...
	public static void Verify_Private_Cart_Page_MoveToWishlist(int iTestCaseRow) throws Exception {
		...
		try {
			Utils.jsClick(MiniCart_Page.RemoveSingleItemFromCart());
		...
		try {
			Utils.verifyElement(Cart_Page.ContinueShoppingButtonEmptyPage());
			Utils.verifyElement(Cart_Page.FromYourWishlistImage());
			Utils.jsClick(Cart_Page.ContinueShoppingButtonEmptyPage());
			Log.info("Coutinue Shopping button clicked successfully");
			Thread.sleep(3000);
