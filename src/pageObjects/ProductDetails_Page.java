	...
	public static class Product {
		...
		public static List<WebElement> size_variant_buttonlist() throws Exception {
			...
			try {
				...
				element2 = Driver.findElements(By.xpath("//*[@class='variant_size_ulClass']/li/button"));
		...
		public static WebElement Product_AddToCart() throws Exception {
			...
			try {
				...
				element = Driver
						.findElement(By.xpath("(.//*[@id='addToCartButton'])[2]"));
				Utils.highLight(element);
		...
		public static WebElement PinCodeSuccessMsg() throws Exception {
			...
			try {
				...
				element = Driver.findElement(By.xpath("//*[contains(text(),'We deliver to this pin code')]"));
				Utils.highLight(element);
