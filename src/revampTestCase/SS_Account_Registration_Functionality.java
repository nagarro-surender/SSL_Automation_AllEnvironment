	...
	public void main() throws Exception {
		try {
			...
			try{
				...
				throw new Exception("Log Out Functionality not working");
			}
			Thread.sleep(2000);
			
//			try{
//				//Utils.mouseHover(Home_Page.LoginRegister());
//				//Utils.mouseHover(Home_Page.Help());
//				Utils.jsClick(Home_Page.headerStoreLocatorIcon());
//				Thread.sleep(3000);
//				Utils.jsClick(Home_Page.LoginRegister());
//				Utils.verifyElement(Home_Page.SignUp());
//			}catch(Exception e){
//				throw new Exception("Post Log Out Sign Up Link is not visible");
//			}
