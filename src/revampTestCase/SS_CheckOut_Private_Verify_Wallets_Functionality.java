...
public class SS_CheckOut_Private_Verify_Wallets_Functionality {
	...
	public void main() throws Exception {
		try {
			...
			if(Utils.getURL().equals(ExcelUtils.getCellData(iTestCaseRow, Constant.currentURL))){
				System.out.println("URL is same .. Test Case passed");
				Log.info("URL is same .. Test Case passed");
			}
			else{
				Log.error("URL mismatched");
				throw new Exception("URL mismatched for CC Avenue");
			}
